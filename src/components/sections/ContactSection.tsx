...
import sectionBg from "@/assets/hero-leaves.jpg";

export function ContactSection() {
  return (
    <section id="contact" className="relative min-h-[80vh] py-24">
      {/* Background */}
        ...
        <div className="max-w-xl">
          ...
          <div className="space-y-8 mb-12">
            <div>
              ...
              <p className="info-value">+91 11 2345 6789</p>
            </div>
            ...
            <div>
              ...
              <p className="info-value">hello@greenbridge.in</p>
            </div>
          ...
          {/* Social Links */}
          <div>
            <p className="info-label mb-3">Follow Us</p>
            <div className="flex gap-4">
              <a
                href="#"
                className="w-10 h-10 rounded-full border border-cream/30 flex items-center justify-center text-cream hover:bg-cream hover:text-forest-dark transition-all"
              >
